...
public class MarbleSinkStrategy implements SinkPriceStrategy {

    @Override
    public Long calculatePrice(Price price) {
        return safeAdd(price.getBathroomPrices().getSinkMarbleMaterials(),
                price.getBathroomPrices().getSinkMarbleLabor());
    }
