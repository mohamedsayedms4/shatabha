...
public class MarbleFloorOtherStrategy extends BaseClassPriceAreaPermaitair implements FloorWallPriceStrategy {

    public MarbleFloorOtherStrategy(Price price, Double area, Double perimeter) {
        super(price, area, perimeter);
    }

    @Override
    public Long calculatePrice() {
        return safeAdd(price.getFloorWallPrices().getMarbleFloorOtherMaterials(),
                price.getFloorWallPrices().getMarbleFloorOtherLabor(),
                area);
    }
