...
public class Ceramic_60x60_Floor extends BaseClassPriceAreaPermaitair implements FloorWallPriceStrategy {
    public Ceramic_60x60_Floor(Price price, Double area, Double perimeter) {
        super(price, area, perimeter);
    }

    @Override
    public Long calculatePrice() {
        return safeAdd(price.getFloorWallPrices().getCeramicFloor60x60Materials(),
