...
public class MarbleFloorKarraraStrategy extends BaseClassPriceAreaPermaitair implements FloorWallPriceStrategy {

    public MarbleFloorKarraraStrategy(Price price, Double area, Double perimeter) {
        super(price, area, perimeter);
    }

    @Override
    public Long calculatePrice() {
        return safeAdd(price.getFloorWallPrices().getMarbleFloorKarraraMaterials(),
                price.getFloorWallPrices().getMarbleFloorKarraraLabor(),
                area);
    }
