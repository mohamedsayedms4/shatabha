...
public class Spanish_Porcelain_60x120_Floor extends BaseClassPriceAreaPermaitair implements FloorWallPriceStrategy {
    public Spanish_Porcelain_60x120_Floor(Price price, Double area, Double perimeter) {
        super(price, area, perimeter);
    }

    @Override
    public Long calculatePrice() {
        return safeAdd(price.getFloorWallPrices().getSpanishPorcelainFloor60x120Materials(),
                price.getFloorWallPrices().getSpanishPorcelainFloor60x120Labor(),
                area);
    }
