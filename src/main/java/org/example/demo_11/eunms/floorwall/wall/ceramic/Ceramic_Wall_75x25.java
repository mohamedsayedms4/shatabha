...
public class Ceramic_Wall_75x25 extends BaseClassPriceAreaPermaitair implements FloorWallPriceStrategy {

    public Ceramic_Wall_75x25(Price price, Double area, Double perimeter) {
        super(price, area, perimeter);
    }

    @Override
    public Long calculatePrice() {
        return safeAdd(price.getFloorWallPrices().getCeramicWall75x25Materials(),
                price.getFloorWallPrices().getCeramicWall75x25Labor(),
                perimeter);
    }
