...
public class Porcelain_Spanish_Wall_120x180 extends BaseClassPriceAreaPermaitair implements FloorWallPriceStrategy {

    public Porcelain_Spanish_Wall_120x180(Price price, Double area, Double perimeter) {
        super(price, area, perimeter);
    }

    @Override
    public Long calculatePrice() {
        return safeAdd(price.getFloorWallPrices().getSpanishPorcelainWall120x180Materials(),
                price.getFloorWallPrices().getSpanishPorcelainWall120x180Labor(),
                perimeter);
    }
