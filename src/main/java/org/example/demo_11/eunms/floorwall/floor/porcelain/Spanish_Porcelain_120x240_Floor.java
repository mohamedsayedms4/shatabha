...
public class Spanish_Porcelain_120x240_Floor extends BaseClassPriceAreaPermaitair implements FloorWallPriceStrategy {
    public Spanish_Porcelain_120x240_Floor(Price price, Double area, Double perimeter) {
        super(price, area, perimeter);
    }

    @Override
    public Long calculatePrice() {
        return safeAdd(price.getFloorWallPrices().getSpanishPorcelainFloor120x240Materials(),
                price.getFloorWallPrices().getSpanishPorcelainFloor120x240Labor(),
                area);
    }
