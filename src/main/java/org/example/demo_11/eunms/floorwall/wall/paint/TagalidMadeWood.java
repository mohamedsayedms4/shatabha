...
public class TagalidMadeWood extends BaseClassPriceAreaPermaitair implements FloorWallPriceStrategy {

    public TagalidMadeWood(Price price, Double area, Double perimeter) {
    ...
    public Long calculatePrice() {
        ...
        Long materials = price.getFloorWallPrices().getTagalidMadeWoodMaterials();
        Long labor = price.getFloorWallPrices().getTagalidMadeWoodLabor();
