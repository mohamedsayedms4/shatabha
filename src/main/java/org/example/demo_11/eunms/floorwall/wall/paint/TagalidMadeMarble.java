...
public class TagalidMadeMarble extends BaseClassPriceAreaPermaitair implements FloorWallPriceStrategy {

    public TagalidMadeMarble(Price price, Double area, Double perimeter) {
    ...
    public Long calculatePrice() {
        ...
        Long materials = price.getFloorWallPrices().getTagalidMadeMarbleMaterials();
        Long labor = price.getFloorWallPrices().getTagalidMadeMarbleLabor();
