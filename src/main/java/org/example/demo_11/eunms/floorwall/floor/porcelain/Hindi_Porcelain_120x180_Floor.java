...
public class Hindi_Porcelain_120x180_Floor extends BaseClassPriceAreaPermaitair implements FloorWallPriceStrategy {
    public Hindi_Porcelain_120x180_Floor(Price price, Double area, Double perimeter) {
        super(price, area, perimeter);
    }

    @Override
    public Long calculatePrice() {
        return safeAdd(price.getFloorWallPrices().getHindiPorcelainFloor120x180Materials(),
                price.getFloorWallPrices().getHindiPorcelainFloor120x180Labor(),
                area);
    }
