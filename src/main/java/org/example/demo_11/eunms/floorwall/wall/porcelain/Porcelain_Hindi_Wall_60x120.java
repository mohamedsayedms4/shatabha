...
public class Porcelain_Hindi_Wall_60x120 extends BaseClassPriceAreaPermaitair implements FloorWallPriceStrategy {

    public Porcelain_Hindi_Wall_60x120(Price price, Double area, Double perimeter) {
        super(price, area, perimeter);
    }

    @Override
    public Long calculatePrice() {
        return safeAdd(price.getFloorWallPrices().getHindiPorcelainWall60x120Materials(),
                price.getFloorWallPrices().getHindiPorcelainWall60x120Labor(),
                perimeter);
    }
