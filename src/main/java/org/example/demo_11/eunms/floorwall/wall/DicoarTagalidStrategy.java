...
public class DicoarTagalidStrategy extends BaseClassPriceAreaPermaitair implements FloorWallPriceStrategy {

    public DicoarTagalidStrategy(Price price, Double area, Double perimeter) {
