...
public class PaintStretchStrategy extends BaseClassPriceAreaPermaitair implements FloorWallPriceStrategy {

    public PaintStretchStrategy(Price price, Double area, Double perimeter) {
        super(price, area, perimeter);
    }

    @Override
    public Long calculatePrice() {
        return safeAdd(price.getCeilingPrices().getCeilingPaintStretchMaterials(),
                price.getCeilingPrices().getCeilingPaintStretchLabor(),
                area);
    }
