...
public class Hindi_Porcelain_60x120_Floor extends BaseClassPriceAreaPermaitair implements FloorWallPriceStrategy {
    public Hindi_Porcelain_60x120_Floor(Price price, Double area, Double perimeter) {
        super(price, area, perimeter);
    }

    @Override
    public Long calculatePrice() {
        return safeAdd(price.getFloorWallPrices().getHindiPorcelainFloor60x120Materials(),
                price.getFloorWallPrices().getHindiPorcelainFloor60x120Labor(),
                area);
    }
