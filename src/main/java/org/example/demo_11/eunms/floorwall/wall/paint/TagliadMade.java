...
public class TagliadMade extends BaseClassPriceAreaPermaitair implements FloorWallPriceStrategy {
    public TagliadMade(Price price, Double area, Double perimeter) {
        super(price, area, perimeter);
    }

    @Override
    public Long calculatePrice() {
        return safeAdd(price.getFloorWallPrices().getTagliadMadeMaterials(),
                price.getFloorWallPrices().getTagliadMadeLabor(),
                perimeter);
    }
