...
public class Porcelain_Spanish_Wall_120x240 extends BaseClassPriceAreaPermaitair implements FloorWallPriceStrategy {

    public Porcelain_Spanish_Wall_120x240(Price price, Double area, Double perimeter) {
        super(price, area, perimeter);
    }

    @Override
    public Long calculatePrice() {
        return safeAdd(price.getFloorWallPrices().getSpanishPorcelainWall120x240Materials(),
                price.getFloorWallPrices().getSpanishPorcelainWall120x240Labor(),
                perimeter);
    }
